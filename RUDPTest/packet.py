class Packet:
    ...
    def decode(self, data):
        flags = data[0]
        self.syn = int((flags & 4) > 0) # if the data[0] is 4 then syn flag
        self.ack = int((flags & 2) > 0) # if the data[0] is 4 then syn flag
        self.fin = int((flags & 1) > 0) # if the data[0] is 4 then syn flag
